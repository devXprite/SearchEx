    ...
    return (
        <footer className={styles.footer}>
            <div className={styles.footer__text}>
                ...
                <p> <span className={styles.logo}>Apubmed</span> is a Free and Open Source project. <br /> You can view its source code on <a href="https://github.com/" target="_blank">Github</a> </p>
                <ThemeBtn />
            </div>
